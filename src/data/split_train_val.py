...
def create_parser() -> ArgumentParser:
    ...
    parser.add_argument(
        'out_path',
        help='path to the folder to store train and validation files',
    )
    parser.add_argument(
        '--val_size',
        nargs='?',
...
if __name__ == '__main__':
    ...
    train_df, val_df = split_train_val(
        args.data_path, args.val_size, RANDOM_STATE
    )
    ...
    train_df.to_csv(os.path.join(target_folder, 'train_data.csv'), index=False)
